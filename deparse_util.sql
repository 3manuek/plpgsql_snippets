...
ALTER TABLE tt ADD COLUMN tt_key int;
ALTER TABLE tt ADD PRIMARY KEY (tt_key);

CREATE TABLE qq(i int PRIMARY KEY, a int REFERENCES tt);
ALTER TABLE qq ALTER CONSTRAINT qq_a_fkey DEFERRABLE;
ALTER TABLE qq SET WITHOUT OIDS;


ALTER TABLE tt ADD COLUMN for_rule int;
CREATE RULE tt_update AS ON UPDATE TO tt DO INSTEAD NOTHING;
ALTER TABLE tt DISABLE RULE tt_update;
ALTER TABLE tt ENABLE RULE tt_update;

ALTER TABLE tt ADD COLUMN i int;
ALTER TABLE tt ADD CONSTRAINT tt_i_check  CHECK (i >0);


ALTER TABLE tt ADD COLUMN b text;
ALTER TABLE tt ALTER COLUMN b SET STORAGE EXTERNAL;
-- ALTER TABLE tt ADD CONSTRAINT tt_b_check CHECK (b > 0);
ALTER TABLE tt ALTER COLUMN b SET DEFAULT 'nop';
CREATE INDEX tt_ix ON tt(b);
ALTER TABLE tt CLUSTER ON tt_ix;
ALTER TABLE tt SET WITHOUT CLUSTER;
...
ALTER TABLE tt DROP CONSTRAINT IF EXISTS tt_b_check CASCADE;
...
ALTER TABLE tt REPLICA IDENTITY NOTHING;
ALTER TABLE tt ENABLE TRIGGER ALL;
